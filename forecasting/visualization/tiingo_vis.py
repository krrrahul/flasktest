...
start = pd.to_datetime('28-07-2017').date()
end = pd.to_datetime('28-07-2018').date()
df_temp = pd.read_csv('C:/work/data/stock.csv')
...
app.layout = html.Div([
    html.Div([
        html.H4('Stock Data [Google,Facebook,Twitter,Amazon,Apple] between 28-07-2017 to 28-07-2018',style={'float': 'left',}),
        ]),
    ...
    dcc.DatePickerRange(
        ...
        min_date_allowed=pd.to_datetime('28-07-2017').date(),
        max_date_allowed=pd.to_datetime('28-07-2018').date(),
        initial_visible_month=pd.to_datetime('28-07-2017').date(),
        start_date  = pd.to_datetime('28-07-2017').date(),
        end_date=pd.to_datetime('28-07-2018').date()
    ),
...
def update_graph(data_names,start_date,end_date):
    ...
    df = pd.read_csv('C:/work/data/stock.csv')
